-- First drop the total_score column that depends on other columns
ALTER TABLE public.honorarium_reports DROP COLUMN total_score;

-- Now drop the old 5 assessment columns
...
-- Add back the total score calculation for 10 questions (max 50)
ALTER TABLE public.honorarium_reports 
