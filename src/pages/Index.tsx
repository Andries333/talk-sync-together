    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {activeTab === "calendar" && (
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-primary">Gemeenskapskalender</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <Calendar size={64} className="mx-auto mb-4 text-muted-foreground" />
                <p className="text-muted-foreground mb-4">Kalender funksionaliteit sal hier kom</p>
                <p className="text-sm text-muted-foreground">
                  Supabase moet eers gekoppel word vir real-time sinkronisering
                </p>
              </div>
            </CardContent>
          </Card>
